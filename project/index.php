...
<body>
  ...
  <label class="form-check-label">
    <b style="margin-right:70px;">Gender :</b><input type="radio" class="form-check-input" name="gender" value="male" checked>Male
  </label>
</div>
<div class="form-check-inline">
  <label class="form-check-label">
...
<div class="form-group">
  ...
  <label class="form-check-label">
  <input type="file" class="picture"name="picture" style="width:300px;height:auto" required>
  </label>
</div>

 
  <br>
  <input type="submit"  name="SignUp" value="SignUp" id="submit" class="form-control" style="font-size:larger;">
